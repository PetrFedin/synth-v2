...
CREATE INDEX IF NOT EXISTS boms_brand_status_sku_idx
  ON boms (brand_id, status, sku);
CREATE INDEX IF NOT EXISTS bom_lines_material_code_idx
  ON bom_lines (material_code, bom_id);
