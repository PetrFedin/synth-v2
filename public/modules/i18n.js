(function initializeSynthaI18n(global) {
  ...
  const localeIndex = locale => locale === 'en' ? 1 : 0;
  ...
  const statusKeys = Object.freeze(['online','active','pending','draft','open','published','accepted','ready','attached','cancelled','read']);
  const statusValues = Object.freeze({
    ru: Object.freeze(['\u043e\u043d\u043b\u0430\u0439\u043d','\u0430\u043a\u0442\u0438\u0432\u043d\u043e','\u043e\u0436\u0438\u0434\u0430\u0435\u0442','\u0447\u0435\u0440\u043d\u043e\u0432\u0438\u043a','\u043e\u0442\u043a\u0440\u044b\u0442\u043e','\u043e\u043f\u0443\u0431\u043b\u0438\u043a\u043e\u0432\u0430\u043d\u043e','\u043f\u0440\u0438\u043d\u044f\u0442\u043e','\u0433\u043e\u0442\u043e\u0432','\u043f\u0440\u0438\u043a\u0440\u0435\u043f\u043b\u0451\u043d','\u043e\u0442\u043c\u0435\u043d\u0451\u043d','\u043f\u0440\u043e\u0447\u0438\u0442\u0430\u043d\u043e']),
    en: Object.freeze(['online','active','pending','draft','open','published','accepted','ready','attached','cancelled','read']),
  });
  const stageKeys = Object.freeze(['campaign','collection','showroom','selection','order-builder','order','confirmation','deal-space']);
  const stageValues = Object.freeze({
    ru: Object.freeze(['\u041a\u0430\u043c\u043f\u0430\u043d\u0438\u044f','\u041a\u043e\u043b\u043b\u0435\u043a\u0446\u0438\u044f','\u0428\u043e\u0443\u0440\u0443\u043c','\u041e\u0442\u0431\u043e\u0440','\u041a\u043e\u043d\u0441\u0442\u0440\u0443\u043a\u0442\u043e\u0440 \u0437\u0430\u043a\u0430\u0437\u0430','\u0417\u0430\u043a\u0430\u0437','\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u0435','DealSpace']),
    en: Object.freeze(['Campaign','Collection','Showroom','Selection','Order Builder','Order','Confirmation','DealSpace']),
  });

  for (const [index, key] of statusKeys.entries()) messages[`status.${key}`] = [statusValues.ru[index], statusValues.en[index]];
  for (const [index, key] of stageKeys.entries()) messages[`stage.${key}`] = [stageValues.ru[index], stageValues.en[index]];
  ...
  const phrasePairs = Object.freeze([
    ...
    ['\u0420\u0430\u0431\u043e\u0447\u0435\u0435 \u043f\u0440\u043e\u0441\u0442\u0440\u0430\u043d\u0441\u0442\u0432\u043e \u0448\u043e\u0443\u0440\u0443\u043c\u043e\u0432','Showroom workspace'],
    ['\u0428\u043e\u0443\u0440\u0443\u043c\u043e\u0432 \u043f\u043e\u043a\u0430 \u043d\u0435\u0442.','No showrooms yet.'],
    ['\u041d\u0430\u0447\u0430\u0442\u044c \u0446\u0438\u043a\u043b','Start cycle'],
    ['\u041e\u0442\u0431\u043e\u0440 \u0437\u0430\u043a\u0443\u043f\u0449\u0438\u043a\u0430','Buyer Selection'],
    ...
    ['\u0414\u043e\u0441\u0442\u0443\u043f\u043d\u043e\u0435 \u043a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e','Sellable quantity'],
    ['\u041e\u0442\u043a\u0440\u044b\u0442\u0438\u0435','Opening'],
    ['\u0417\u0430\u043a\u0440\u044b\u0442\u0438\u0435','Closing'],
    ['\u041c\u0430\u0433\u0430\u0437\u0438\u043d','Shop'],
    ...
    ['\u041e\u043f\u0435\u0440\u0430\u0446\u0438\u043e\u043d\u043d\u0430\u044f wholesale-\u0441\u0438\u0441\u0442\u0435\u043c\u0430','Wholesale OS'],
  ]);
  ...
  function t(key, parameters = {}) {
    ...
    if (!pair) return key;
    return interpolate(pair[localeIndex(currentLocale)], parameters);
  }

  function translate(value) {
    if (typeof value !== 'string' || value.length === 0) return value;
    const target = localeIndex(currentLocale);
    for (const pair of phrasePairs) if (value === pair[0] || value === pair[1]) return pair[target];
    for (const pair of prefixPairs) {
      const sourceIndex = value.startsWith(pair[0]) ? 0 : value.startsWith(pair[1]) ? 1 : -1;
      if (sourceIndex >= 0) return pair[target] + translate(value.slice(pair[sourceIndex].length));
    }
    if (currentLocale === 'en') {
  ...
  function diagnostics() {
    const invalidMessages = Object.entries(messages).filter(([, pair]) => !Array.isArray(pair) || pair.length !== SUPPORTED_LOCALES.length);
    const invalidPhrases = phrasePairs.filter(pair => !Array.isArray(pair) || pair.length !== SUPPORTED_LOCALES.length);
    return Object.freeze({
      locales: [...SUPPORTED_LOCALES],
      locale: currentLocale,
      messageCount: Object.keys(messages).length,
      phraseCount: phrasePairs.length,
      invalidMessageKeys: invalidMessages.map(([key]) => key),
      invalidPhraseCount: invalidPhrases.length,
    });
  }
