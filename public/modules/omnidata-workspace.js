...
function renderSelections() {
  ...
  return odPage(odText('\u0410\u0441\u0441\u043e\u0440\u0442\u0438\u043c\u0435\u043d\u0442\u044b \u0431\u0430\u0439\u0435\u0440\u0430', 'Buyer selection'), header, odRegistry({ scope: 'od-selections', filterScope: 'selections', rows: w.selections, columns: [{ label: 'Selection', value: item => item.id }, { label: odText('\u0428\u043e\u0443\u0440\u0443\u043c', 'Showroom'), value: item => nameById('showrooms', item.showroomId) }, { label: odText('\u041c\u0430\u0433\u0430\u0437\u0438\u043d', 'Shop'), value: item => orgName(item.shopId) }, { label: odText('\u041f\u043e\u0437\u0438\u0446\u0438\u0438', 'Lines'), value: item => odList(item.lines).length }, { label: odText('\u0415\u0434\u0438\u043d\u0438\u0446\u044b', 'Units'), value: item => odList(item.lines).reduce((sum, line) => sum + Number(line.quantity || 0), 0) }, { label: odText('\u0421\u0442\u0430\u0442\u0443\u0441', 'Status'), render: item => statusBadge(item.status) }], inspector: item => odInspector({ title: item.id, subtitle: nameById('showrooms', item.showroomId), status: item.status, preview: header.active === 'buyer', tabs: [odText('\u0421\u043e\u0441\u0442\u0430\u0432', 'Lines'), odText('\u0423\u0441\u043b\u043e\u0432\u0438\u044f', 'Terms'), odText('\u0418\u0441\u0442\u043e\u0440\u0438\u044f', 'History')], fields: [{ label: 'Linesheet', value: nameById('showrooms', item.showroomId) }, { label: odText('\u041c\u0430\u0433\u0430\u0437\u0438\u043d', 'Shop'), value: orgName(item.shopId) }, { label: odText('\u041f\u043e\u0437\u0438\u0446\u0438\u0438', 'Lines'), value: odList(item.lines).length }, { label: odText('\u0415\u0434\u0438\u043d\u0438\u0446\u044b', 'Units'), value: odList(item.lines).reduce((sum, line) => sum + Number(line.quantity || 0), 0) }], content: [odMiniTable(['SKU', odText('\u041a\u043e\u043b-\u0432\u043e', 'Qty'), odText('\u0426\u0435\u043d\u0430', 'Price')], odList(item.lines).map(line => [line.sku, line.quantity, money(line.unitPrice)]))], actions: odSelectionActions(item) }) }));
}
