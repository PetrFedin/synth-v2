...
function renderNotifications() {
  ...
  const body = odRegistry({ scope: 'od-notifications', filterScope: 'notifications', rows, columns: [{ label: odText('\u0422\u0435\u043c\u0430', 'Subject'), value: item => humaniseIdentifiers(item.title || item.type), title: item => item.title || '' }, { label: odText('\u0422\u0438\u043f', 'Type'), value: item => statusLabel(item.type) }, { label: odText('\u0421\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435', 'Message'), value: item => humaniseIdentifiers(item.body || item.message || '\u2014') }, { label: odText('\u0414\u0430\u0442\u0430', 'Date'), value: item => formatDate(item.createdAt) }, { label: odText('\u0421\u0442\u0430\u0442\u0443\u0441', 'Status'), render: item => statusBadge(item.status) }], inspector: item => odInspector({ title: humaniseIdentifiers(item.title || item.type), subtitle: formatDate(item.createdAt), status: item.status, tabs: [odText('\u0421\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435', 'Message'), odText('\u041a\u043e\u043d\u0442\u0435\u043a\u0441\u0442', 'Context'), odText('\u0418\u0441\u0442\u043e\u0440\u0438\u044f', 'History')], fields: [{ label: odText('\u0422\u0438\u043f', 'Type'), value: statusLabel(item.type) }, { label: odText('\u0414\u0430\u0442\u0430', 'Date'), value: formatDate(item.createdAt) }, { label: odText('\u0421\u043e\u043e\u0431\u0449\u0435\u043d\u0438\u0435', 'Message'), value: humaniseIdentifiers(item.body || item.message || '\u2014') }], actions: item.status !== 'read' ? [notificationReadButton(item)] : [] }) });
