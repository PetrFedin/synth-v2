...
function odShowroomAccess(item) {
  ...
  return odMiniTable(
    [odText('\u041c\u0430\u0433\u0430\u0437\u0438\u043d', 'Shop'), odText('\u0421\u0442\u0430\u0442\u0443\u0441', 'Status'), odText('\u0414\u0435\u0439\u0441\u0442\u0432\u0443\u0435\u0442 \u0434\u043e', 'Expires')],
    rows.map(invitation => [orgName(invitation.shopId), statusLabel(invitation.status), formatDate(invitation.expiresAt)]),
  );
}
