(function initializeUiCapabilities(global) {
  ...
  const BY_ROLE = Object.freeze({
    ...
    finance: Object.freeze([CAPABILITIES.BOM_READ, CAPABILITIES.TECH_PACK_READ, CAPABILITIES.SUPPLIER_READ, CAPABILITIES.SOURCING_READ, CAPABILITIES.ORDER_CONFIRM]),
