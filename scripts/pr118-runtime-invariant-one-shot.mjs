...
replaceOnce('tests/canonical-measurement-domain.test.mjs', persistedMdmBefore, persistedMdmAfter);
replaceOnce('tests/canonical-measurement-service.test.mjs', persistedMdmBefore, persistedMdmAfter);
replaceOnce(
...
replaceOnce(readyPath, '    row.sku_brand_id,\n    row.media_brand_id,', '    row.sku_brand_id,\n    row.inventory_brand_id,\n    row.media_brand_id,');
replaceOnce(
  readyPath,
...
replaceOnce(readyPath, oldIsolation, newIsolation);
