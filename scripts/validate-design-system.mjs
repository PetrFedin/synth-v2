...
console.log(`Omnidata Design System v1 contract OK (${ROLES.length} roles, ${PARTS.length} semantic parts, ${styledParts.size} styled parts, ${TOKENS.length} tokens; Samples, Tech Packs, Production Executions, Production Orders and Final Quality ODS-native).`);
