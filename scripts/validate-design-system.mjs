...
const LEGACY_WORKSPACE_STYLES=['/industrial-product.css','/bom.css','/measurements.css','/samples.css','/sourcing.css','/tech-packs.css'];
...
const ODS_NATIVE_STYLES=['/production-executions.css','/production-orders.css','/final-quality.css'];
...
console.log(`Omnidata Design System v1 contract OK (${ROLES.length} roles, ${PARTS.length} semantic parts, ${styledParts.size} styled parts, ${TOKENS.length} tokens; Production Executions, Production Orders and Final Quality ODS-native).`);
