...
console.log(`ODS boundary contract OK (${presentLegacyDebt.length}/${LEGACY_VISUAL_DEBT.length} frozen legacy styles remain; Samples, Tech Packs, Production Executions, Production Orders and Final Quality are ODS-native; no new stylesheet or dynamic style API).`);
