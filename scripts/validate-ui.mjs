...
if(!stylesheets.includes('/omnidata-v12.css')||stylesheets.at(-1)!=='/omnidata-v13.css')fail('Omnidata V13 must be loaded as the final corrective visual system.');
