...
export function normalizeHttpError(error) {
  ...
  if (code === 'HTTP_ROUTE_NOT_FOUND' || code.endsWith('_NOT_FOUND')) status = 404;
    ...
    'CATALOG_BULK_INVALID',
    'CATALOG_BULK_FIELD_FORBIDDEN',
    'CATALOG_BULK_SIZE_INVALID',
    'CATALOG_BULK_OPERATION_INVALID',
    'CATALOG_BULK_OPERATION_TYPE_INVALID',
    'CATALOG_BULK_OPERATION_FIELD_FORBIDDEN',
    'CATALOG_BULK_SKU_INVALID',
    'CATALOG_BULK_SKU_DUPLICATE',
    'AUTH_EMAIL_INVALID',
