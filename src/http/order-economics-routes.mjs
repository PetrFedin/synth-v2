...
const COST_BODY = bodyContract(['costType', 'amount', 'currency', 'sku', 'sourceRef', 'occurredAt']);
...
function unavailableOrderEconomics() {
  ...
  return Object.freeze({ createSupplyCommitment: fail, recordActualCost: fail, actualizeLandedCost: fail, actualizeMargin: fail, getMarginForActor: fail });
}
