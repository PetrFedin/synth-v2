...
const SELECTION_BODY = bodyContract(['cycleId', 'showroomId', 'retailDoorId']);
...
const ORDER_BODY = bodyContract(['selectionId', 'retailDoorId', 'terms'], { terms: ORDER_TERMS_FIELDS });
