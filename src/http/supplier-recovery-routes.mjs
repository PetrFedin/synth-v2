...
const RECOVERY_BODY = bodyContract(['supplierCode','amount','currency','fxRateSnapshotId','sku','sourceRef','occurredAt','reason']);
...
function validate(body){
  ...
  optionalText(body.fxRateSnapshotId,'fxRateSnapshotId',200); optionalText(body.sku,'sku',160);
