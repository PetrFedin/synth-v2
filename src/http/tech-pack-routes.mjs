...
function unavailable() {
  ...
  return Object.freeze({ pageForActor: fail, getForActor: fail, createTechPack: fail, updateTechPack: fail, issueTechPack: fail, acknowledgeTechPack: fail, createRevision: fail, withdrawTechPack: fail });
}
