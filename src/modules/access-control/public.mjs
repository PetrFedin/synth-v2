...
export const CAPABILITIES = Object.freeze({
  ...
  PRODUCTION_TRACKING_READ: 'production-tracking.read',
  PRODUCTION_TRACKING_MANAGE: 'production-tracking.manage',
...
export const ROLE_CAPABILITIES = Object.freeze({
  ...
  sales: Object.freeze([
    ...
    CAPABILITIES.PRODUCTION_TRACKING_READ,
    CAPABILITIES.PRODUCTION_TRACKING_MANAGE,
