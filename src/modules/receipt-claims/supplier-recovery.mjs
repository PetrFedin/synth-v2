...
export function createSupplierRecoverySnapshot({
  id,
  resolution,
  supplier,
  actualCost,
  ...
  const timestamp = requiredTimestamp(recordedAt, 'SUPPLIER_RECOVERY_RECORDED_AT_INVALID');
