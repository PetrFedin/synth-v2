...
import { createNotificationService } from '../application/notification-cursor-service.mjs';
...
import { createPostgresNotificationProjectionStore } from '../infrastructure/postgres-notification-cursor-store.mjs';
