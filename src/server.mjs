...
const settings = Object.freeze({
  ...
  maxLoginFailures: integerSetting('SYNTHA_AUTH_MAX_FAILURES', 5, 1, 100),
  loginWindowMs: integerSetting('SYNTHA_AUTH_WINDOW_MS', 900_000, 1_000, 86_400_000),
  loginBlockMs: integerSetting('SYNTHA_AUTH_BLOCK_MS', 900_000, 1_000, 86_400_000),
