...
test('V10 and V11 remain beneath final V12 delivery',async()=>{const html=await source('public/index.html');const handler=await source('src/web/static-handler.mjs');const v10=html.indexOf('/omnidata-v10.css?v=visual-20260804-10');const v11=html.indexOf('/omnidata-v11.css?v=visual-20260804-11');const v12=html.indexOf('/omnidata-v12.css?v=visual-20260804-12');assert.ok(v10>=0&&v11>v10&&v12>v11);assert.match(html,/meta name="syntha-build" content="visual-20260804-12"/);assert.ok(handler.includes("'/omnidata-v12.css': ['omnidata-v12.css'"))});
