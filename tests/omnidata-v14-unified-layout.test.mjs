...
test('V14 adapters and component unifier are final cache-busted no-store assets',async()=>{
  ...
  const scriptOrder=['/ui/production-orders.js?v=industrial-20260805-1','/ui/omnidata-v14.js?v=visual-20260805-14','/ui/omnidata-v14-module-adapters.js?v=visual-20260805-14-module-adapters-3','/ui/omnidata-v14-components.js?v=visual-20260805-14-components-2','/ui/dom-boolean-props.js?v=visual-20260804-9'];
