...
test('OpenAPI 1.13 publishes strict supplier, quotation, award and production allocation contracts', () => {
  assert.equal(wholesaleV2ExtendedOpenApi.info.version, '1.13.0');
