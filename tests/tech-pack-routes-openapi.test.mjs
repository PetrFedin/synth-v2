...
test('authoritative OpenAPI 1.16 documents supplier acknowledgement and guarded production allocation', () => {
  const specification = wholesaleV2ExtendedOpenApi; assert.equal(specification.info.version, '1.16.0');
