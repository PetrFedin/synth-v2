...
test('authoritative OpenAPI 1.15 documents supplier acknowledgement and guarded production allocation', () => {
  const specification = wholesaleV2ExtendedOpenApi; assert.equal(specification.info.version, '1.15.0');
